...
public class UsuarioControllerTest {
	...
	public void start() throws ParseException {
		...
		if (!usuarioRepository.findByUsuario(usuarioAdmin.getUsuario()).isPresent()) {
			...
			//cria uma requisicao http atraves da classe httpEntity utilizando a classe usuario, ela recebe um objeto
			//usuarioAdmin, o objeto da classe testRestTemplate cria uma requisicao http atraves do caminho usuarios/cadastrar
