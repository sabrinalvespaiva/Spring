...
//caso a api esteja rodando, procura outra porta livre
...
public class UsuarioRepositoryTest {
	...
	//diferente do beforeEach, executa uma vez e na sequencia todos os testes são executados
	@BeforeAll
	void start() throws ParseException {

		Usuario usuario = new Usuario(0, "João da Silva", "joao@email.com.br", "13465278");
		//verifica se o usario e existe e se ele nao existir salva esse usuario acima
	...
	//verifica se o metodo de encontrar o nome no repository funciona
	@Test
