...
public class PostagemController {
	...
	//e ira localizar essa variavel atravez do @pathVariable q ira devolver o objeto dentro desse id ou um not fould caso ele nao exista
	@GetMapping("/{id}")
	...
	//esse recurso sera pego pelo body
	@PostMapping
	public ResponseEntity<Postagem> post (@RequestBody Postagem postagem){
		return ResponseEntity.status(HttpStatus.CREATED).body(repository.save(postagem));
	}
	
	//atualização do post/dado
	@PutMapping
